...
TEST_F(ClassParserTest, testBasicOperations) {
    ...
    ASSERT_TRUE(((Operation*)dynamic_cast<Class*>((*pp.elements)[boost::lexical_cast<boost::uuids::uuid>("190d1cb9-13dc-44e6-a064-126891ae0033")])->getOperations().front())->getParameters().empty() == false);
    ASSERT_TRUE(((Operation*)dynamic_cast<Class*>((*pp.elements)[boost::lexical_cast<boost::uuids::uuid>("190d1cb9-13dc-44e6-a064-126891ae0033")])->getOperations().front())->getParameters().front()->getID() == boost::lexical_cast<boost::uuids::uuid>("7d18ee42-82c6-4f52-8ec4-fab67a75ff35"));
    ASSERT_TRUE(((Parameter*)((Operation*)dynamic_cast<Class*>((*pp.elements)[boost::lexical_cast<boost::uuids::uuid>("190d1cb9-13dc-44e6-a064-126891ae0033")])->getOperations().front())->getParameters().front())->getType()->isPrimitive());
    ASSERT_TRUE(((PrimitiveType*)((Parameter*)((Operation*)dynamic_cast<Class*>((*pp.elements)[boost::lexical_cast<boost::uuids::uuid>("190d1cb9-13dc-44e6-a064-126891ae0033")])->getOperations().front())->getParameters().front())->getType())->getPrimitiveType() == PrimitiveType::Primitive::BOOL);
    ASSERT_TRUE(((Parameter*)((Operation*)dynamic_cast<Class*>((*pp.elements)[boost::lexical_cast<boost::uuids::uuid>("190d1cb9-13dc-44e6-a064-126891ae0033")])->getOperations().front())->getParameters().front())->getName().compare("debug") == 0);
