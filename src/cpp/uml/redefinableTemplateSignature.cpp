...
void RedefinableTemplateSignature::AddExtendedSignatureFunctor::operator()(Element& el) const {
...
void RedefinableTemplateSignature::RemoveExtendedSignatureFunctor::operator()(Element& el) const {
