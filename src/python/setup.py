...
if __name__ == '__main__':
    ...
    copyfile(str(pathlib.Path(__file__).parent.absolute()) +  "/../../build/src/cpp/yuml-python/yuml_python.cpython-38-x86_64-linux-gnu.so", str(pathlib.Path(__file__).parent.absolute()) + "/../test/python/yuml-parsers/yuml_python.cpython-38-x86_64-linux-gnu.so")